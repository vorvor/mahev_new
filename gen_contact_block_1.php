...
<div class="_can-i-help container grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
    ...
    <div class="text-center flex flex-wrap content-center">
        <div class="img rounded-full w-40 h-40 border-2 border-emerald-500 overflow-hidden flex items-center mx-auto">
            <img class="_image-scale block w-full h-full object-cover object-center" src="/resources/img/colleague-mudri-daniel-res.jpg" alt="">
        </div>
        <div class="text-gray-500 font-semibold tracking-wide w-full uppercase mb-4 mt-4">Mudri Dániel</div>
        <div class="text-gray-500 w-full">Cégvezető</div>
    </div>


     <div class="text-center flex flex-wrap content-center">
        <a href= "tel:<?php print $phone_main_raw; ?>" class= "w-full max-w-xs mx-auto mb-8 bg-emerald-500  hover:bg-emerald-600  font-semibold inline-block leading-5 px-6 py-3 rounded-sm text-sm text-center text-white tracking-wider uppercase duration-150 ease-in-out"><?php print $phone_main; ?></a>
