...
-->
                    ...
                    <div class="grid md:grid-cols-2 col-gap-8 row-gap-16">
                        ...
                        <div>
                            <h3>Megbízhatóság</h3>
                            <p>A Magyar Autókereskedőház Zrt. arany minősítési fokozatot ért el az ECDH gépjármű kereskedői minősítése során, valamint megszerezte az ISO 9001-es minősítést. Ez bizonyítja, hogy a vállalkozás felkészült, kollégái és folyamatai rendre szabályozottak.  </p>
                        </div>
                        <div>
                            <h3>Szakértelem</h3>
...
<div class="_section-title3  text- flex leading-loose items-center mx-auto md:mx-0 max-w-md">
    ...
    <div>
        <h2 class="text-2xl md:text-3xl leading-snug">Finanszírozás</h2>
        <div class="w-16 border-t-2 border-emerald-500 ml-0 mt-4 md:mt-8"></div>
    </div>
</div>
                    <div class="lead my-16 md:my-12">
...
<div class="_section-title3  text- flex leading-loose items-center mx-auto md:mx-0 max-w-md">
    ...
    <div>
        <h2 class="text-2xl md:text-3xl leading-snug">Biztosítás</h2>
        <div class="w-16 border-t-2 border-emerald-500 ml-0 mt-4 md:mt-8"></div>
    </div>
</div>
                    <div class="lead my-16 md:my-12">
