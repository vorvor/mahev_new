$(document).ready(function() {
	// Init model.
	$('#configurator').attr('data-model', 'M3');

	// Init facility option buttons.
	$('._configurator-tabs #conf-tab-1 ._radio-extras').attr('data-prop', 'facility');
	$('._configurator-tabs #conf-tab-1 ._radio-extras:eq(0)').attr('data-val', 'SRP');
	$('._configurator-tabs #conf-tab-1 ._radio-extras:eq(1)').attr('data-val', 'SRP');
	...
	$('._configurator-tabs #conf-tab-3 ._radio-extras:eq(0)').attr('data-val', '18cAero');
	$('._configurator-tabs #conf-tab-3 ._radio-extras:eq(1)').attr('data-val', '19cSport');
	$('._configurator-tabs #conf-tab-3 ._radio-extras:eq(2)').attr('data-val', '20cUturb');
