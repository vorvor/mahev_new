<!-- section.py-16.bg-gray-50>.container.grid.sm:grid-cols-2.md:grid-cols-4.gap-8>div{text}+div{person}+div>button*2{button text}^div{social}-->
...
<div class="_can-i-help container grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
    ...
    <div class="text-center flex flex-wrap content-center">
        <div class="img rounded-full w-40 h-40 border-2 border-emerald-500 overflow-hidden flex items-center mx-auto">
            <img class="_image-scale block w-full h-full object-cover object-center" src="/resources/img/borka.jpg" alt="">
        </div>
        <div class="text-gray-500 font-semibold tracking-wide w-full uppercase mb-4 mt-4">Borka J. Balázs</div>
        <div class="text-gray-500 w-full">Vezérigazgató</div>

    </div>
    <div class="text-center flex flex-wrap content-center">
        <a href= "tel:+36202578998" class= "w-full max-w-xs mx-auto mb-8 bg-emerald-500  hover:bg-emerald-600  font-semibold inline-block leading-5 px-6 py-3 rounded-sm text-sm text-center text-white tracking-wider uppercase duration-150 ease-in-out">+36202578998</a>
        <a href= "gen_form-message.php" class= "w-full max-w-xs mx-auto bg-gray-300  hover:bg-gray-400  font-semibold inline-block leading-5 px-6 py-3 rounded-sm text-sm text-center text-white tracking-wider uppercase duration-150 ease-in-out">Üzenetet küldök</a>
    </div>
